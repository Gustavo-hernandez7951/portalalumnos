        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="card card-navy">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">MES DE REINSCRIPCION</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="alert alert-danger" role="alert">
                            <label class="col-md-12 col-form-label text-md-center">En caso de realizar Transferencia Bancaria deberá ser realizado 3 días antes de finalizar el mes.</label>
                    </div>
