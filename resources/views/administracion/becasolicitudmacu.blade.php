    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-md-offset-2">
            ...
            <div class="card card-navy">
                ...
                <div class="alert bg-navy" role="alert">
                    <label class="col-md-12 col-form-label text-md-center">Una vez autorizada la beca acudir al Departamento de Tesorería Posgrado por documento impresó.</label>
                </div>
