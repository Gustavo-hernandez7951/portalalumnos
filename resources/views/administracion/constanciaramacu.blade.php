...
<html lang="es">
    ...
    <body>
        ...
        <h3 align="center" style="font-size:100%;">RENOVACIÓN ANUAL {{$smb->ciclo_solicitud}}</h3>
        ...
        Es un gusto infórmale que su solicitud de renovación de la misma ha sido satisfactorio. Por tal motivo para el periodo ENERO-DICIEMBRE {{$smb->ciclo_solicitud}}, tendrá un descuento
