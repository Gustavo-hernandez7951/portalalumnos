...
<body>
    <div class="container">
        ...
        <main>
            <div class="title">LICENCIATURA - BOLETA DE CALIFICACIONES</div>

            <div class="info-block">
                <h5><span class="highlight">{{$periodos->cat_programa->descripcion}}</span></h5>
                <h5>
                    <span><strong>R.V.O.E.</strong> {{$periodos->cat_programa->rvoe}} | <strong>PERIODO:</strong> {{$periodos->periodo}}</span><br>
                    <span><strong>ALUMNO:</strong> {{ Auth::user()->nombre }}</span><br>
                    <span><strong>MATRÍCULA:</strong> {{ Auth::user()->cuenta }}</span>
                </h5>
            </div>

            <section>
                <h5 style="text-align: center;">Boleta de calificaciones del periodo {{$periodos->periodo}}</h5>
                <table>
                    <thead>
                        <tr>
                            <th scope="col">#</th>
            ...
            <div class="signature">
                <img src="dist/img/firma-guille.png" alt="Firma">
