            ...
            <div class="card card-navy">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive row">
                        ...
                        <div align="center">
                        <a href="{{ route('boletaPDF') }}"><button type="button" class="btn btn-outline-success btn-lg btn-block" {{$btnDescargar}}><i class="fas fa-download"></i> Descargar Boleta</button></a>
                        </div>
