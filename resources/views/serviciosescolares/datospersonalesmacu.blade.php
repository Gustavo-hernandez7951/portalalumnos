        ...
        @foreach($dps as $dp)
            ...
            <div class="card card-navy collapsed-card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">CARTA PASANTE:</label>
                        <p class="col-md-4 col-form-label text-md-left">
                        <?php
                            if ($dp->carta_pasante == true)
                            {
                                echo "✅";
                            }elseif ($dp->carta_pasante == false)
                            {
                                echo "❎";
                            }
                        ?></p>
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">CERTIFICADO PROFESIONAL:</label>
                        <p class="col-md-4 col-form-label text-md-left">
                        <?php
                            if ($dp->certificado_profesional == true)
                            {
                                echo "✅";
                            }elseif ($dp->certificado_profesional == false)
                            {
                                echo "❎";
                            }
                        ?></p>
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">CARTA MOTIVOS:</label>
                        <p class="col-md-4 col-form-label text-md-left">
                        <?php
                            if ($dp->carta_motivos == true)
                            {
                                echo "✅";
                            }elseif ($dp->carta_motivos == false)
                            {
                                echo "❎";
                            }
                        ?></p>
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">OPCION TITULACION:</label>
                        <p class="col-md-4 col-form-label text-md-left">
                        <?php
                            if ($dp->opcion_titulacion == true)
                            {
                                echo "✅";
                            }elseif ($dp->opcion_titulacion == false)
                            {
                                echo "❎";
                            }
                        ?></p>
